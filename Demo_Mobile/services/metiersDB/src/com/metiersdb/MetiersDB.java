...
/**
 *  Operations for service "metiersDB"
 *  09/18/2012 17:50:45
 * 
 */
@SuppressWarnings("unchecked")
public class MetiersDB
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.metiersdb.data.Clients getClientsById(Long id, PagingOptions pagingOptions) {
        List<com.metiersdb.data.Clients> rtn = ((List<com.metiersdb.data.Clients> ) dsMgr.invoke(taskMgr.getQueryTask(), (MetiersDBConstants.getClientsByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
